...
//
// NOTA (testing): el servicio vive en su propio archivo (separado de
// `redis.module.ts`, que ahora es solo cableado DI) para ser coherente con el
// resto del backend —cada servicio en su `*.service.ts`— y para que la regla de
// exclusión de cobertura `*.module.ts` quede limpia sin ocultar esta lógica.
// ============================================================================
